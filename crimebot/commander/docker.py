...
DOCKER_CONTAINERS_GAUGE = Gauge(
    "docker_containers_running", "Number of running Docker Compose containers"
)
...
def get_running_containers():
    ...
    running_containers = {
        container.name for container in containers if container.status == "running"
    }
