...
class WamProviderBase(ABC):
    """
    An abstract base class that defines the core functionality of a (not so) Weak Ass Malware (WAM) provider.
    """
    ...
    @abstractmethod
    def create_tarball(self, env_path: os.PathLike, output_path: os.PathLike) -> None:
        """
